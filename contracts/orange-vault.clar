...
;; Summary: Next-generation Bitcoin-native lending infrastructure utilizing Stacks Layer 2 
;;          technology for permissionless, over-collateralized STX borrowing with 
;;          institutional-grade risk management and autonomous liquidation systems.
;;
;; Description: OrangeVault transforms Bitcoin DeFi by introducing a fully decentralized 
;;              lending marketplace where users leverage STX as premium collateral for 
;;              efficient capital allocation. The protocol implements cutting-edge risk 
;;              assessment algorithms, multi-tiered collateral ratios, and flash-liquidation 
;;              capabilities to ensure maximum capital efficiency while preserving system 
;;              integrity. Engineered for seamless institutional integration with Bitcoin's 
;;              most battle-tested Layer 2 infrastructure, delivering uncompromising security 
;;              and regulatory compliance for the next generation of Bitcoin finance.
...
;; Update minimum collateral ratio requirements
